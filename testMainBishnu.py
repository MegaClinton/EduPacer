...
def ask_questions(subject):
    ...
    for q in questions[subject]:
        ...
        selected_answer = tk.StringVar(value=None)  # Initialize to None for each question
    ...
    def submit_answer(correct_answer, user_answer):
        if user_answer:
            ...
            tk.Label(question_window, text="Please select an answer before submitting.").pack()
